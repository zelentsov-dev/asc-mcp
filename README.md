...
# 1. Install via Mint
brew install mint
mint install zelentsov-dev/asc-mcp@v3.5.0
...
mint install zelentsov-dev/asc-mcp@v3.5.0     # specific tag
```

To update to the latest version:

```bash
mint install zelentsov-dev/asc-mcp@v3.5.0 --force
```
